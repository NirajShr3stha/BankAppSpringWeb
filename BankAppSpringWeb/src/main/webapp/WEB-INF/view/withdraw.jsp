...
<!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                            Enter account number and transfer balance to begin transfer process.
                        ...
                        <form:input id="login" class="fadeIn second" placeholder="AMOUNT TO WITHDRAW" path="accountBalance"/>
