...
<%@page import="com.mycompany.domain.MyAccount"%>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                ...
                <% ArrayList<MyAccount> userList=(ArrayList<MyAccount>) request.getAttribute("aList");
                    Iterator<MyAccount> iter = userList.iterator();
                    System.out.println("Hello");
                    while(iter.hasNext()){
                     MyAccount accnt = iter.next();
                %>
                     <tr>
