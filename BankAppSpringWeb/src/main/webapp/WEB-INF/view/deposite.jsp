...
<!--                            <img src="${pageContext.request.contextPath}/resources/images/logo.png" id="icon" alt="User Icon" />-->
                            Enter account number and deposite balance to begin deposite process.
                            
                            
                        </div>
                            

                        <form:form method="POST" modelAttribute="account" action="processdeposite">
                        <form:input id="login" class="fadeIn second" placeholder="ACCOUNT NUMBER" path="accountNumber"/>
                        <form:input id="login" class="fadeIn second" placeholder="AMOUNT TO DEPOSITE" path="accountBalance"/>
                        <form:button id="submit" class="fadeIn fourth" name="submit">Deposite</form:button>
                        </form:form>
                        <div id="formFooter">
                            ${message}
                        </div>
